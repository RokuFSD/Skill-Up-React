  ...
  return (
    <footer id="footer">
      <ul className="icons">
        ...
        <li>
          <a href="src/pages/landing/index.jsx#" className="icon brands alt fa-facebook-f">
            <span className="label">Facebook</span>
          </a>
        </li>
        <li>
          <a href="src/pages/landing/index.jsx#" className="icon brands alt fa-linkedin-in">
            <span className="label">LinkedIn</span>
          </a>
        </li>
        <li>
          <a href="src/pages/landing/index.jsx#" className="icon brands alt fa-instagram">
            <span className="label">Instagram</span>
          </a>
        </li>
        <li>
          <a href="src/pages/landing/index.jsx#" className="icon brands alt fa-github">
            <span className="label">GitHub</span>
          </a>
        </li>
        <li>
          <a href="src/pages/landing/index.jsx#" className="icon solid alt fa-envelope">
      ...
      <section id="two" className="spotlight style2 right bg-two bg-twoUrl">
        ...
        <div className="content">
          ...
          <ul className="actions">
            <li>
              <a href="src/pages/landing/index.jsx#" className="button">
                Learn More
              </a>
            </li>
          </ul>
