...
import { useModifyTransactionMutation } from '../../../features/transaction/transactionSlice.js';
import PencilSvg from '../../svg/Pencil.jsx';
import CrossSvg from '../../svg/Cross';

function TransactionCard({ id, date, amount, concept, type, to_account_id, accountId, editable = false }) {
  ...
  function handleSubmit() {
    modifyTransaction({ id, data: { date, amount, concept: newConcept, type, to_account_id, accountId } });
    setEditing(!editing);
    setNewConcept('');
  }
