  ...
  return (
    <footer id='footer'>
      <ul className='icons'>
        ...
        <li><a href='src/components/pages/landing/index.jsx#' className='icon brands alt fa-facebook-f'><span className='label'>Facebook</span></a>
        </li>
        <li><a href='src/components/pages/landing/index.jsx#' className='icon brands alt fa-linkedin-in'><span className='label'>LinkedIn</span></a>
        </li>
        <li><a href='src/components/pages/landing/index.jsx#' className='icon brands alt fa-instagram'><span className='label'>Instagram</span></a>
        </li>
        <li><a href='src/components/pages/landing/index.jsx#' className='icon brands alt fa-github'><span className='label'>GitHub</span></a></li>
        <li><a href='src/components/pages/landing/index.jsx#' className='icon solid alt fa-envelope'><span className='label'>Email</span></a></li>
      </ul>
  ...
  return (
    <div id='page-wrapper' className='fakebody'>
      ...
      <section id='one' className='spotlight style1 bottom bg-one bg-oneUrl'>
        ...
        <HashLink smooth to='#two' className='gotoNext'>Next</HashLink>
      </section>
      ...
      <section id='two' className='spotlight style2 right bg-two bg-twoUrl'>
        ...
        <div className='content'>
          ...
          <ul className='actions'>
            <li><a href='src/components/pages/landing/index.jsx#' className='button'>Learn More</a></li>
          </ul>
        </div>
        ...
        <div className='container-unique'>
          ...
          <div className='box alt'>
            <div className='row gtr-uniform'>
              <section className='col4 col-6-medium col-12-xsmall'>
                <span
                  className='icon alt major solid fa-area-chart'></span>
                <h3>Ipsum sed commodo</h3>
                <p>Feugiat accumsan lorem eu ac lorem amet accumsan donec. Blandit orci porttitor.</p>
              </section>
              <section className='col4 col-6-medium col-12-xsmall'>
                <span
                  className='icon alt major solid fa-comment'></span>
                <h3>Eleifend lorem ornare</h3>
                <p>Feugiat accumsan lorem eu ac lorem amet accumsan donec. Blandit orci porttitor.</p>
              </section>
              <section className='col4 col-6-medium col-12-xsmall'>
                <span
                  className='icon alt major solid fa-flask'></span>
                <h3>Cubilia cep lobortis</h3>
                <p>Feugiat accumsan lorem eu ac lorem amet accumsan donec. Blandit orci porttitor.</p>
              </section>
              <section className='col4 col-6-medium col-12-xsmall'>
                <span
                  className='icon alt major solid fa-paper-plane'></span>
                <h3>Non semper interdum</h3>
                <p>Feugiat accumsan lorem eu ac lorem amet accumsan donec. Blandit orci porttitor.</p>
              </section>
              <section className='col4 col-6-medium col-12-xsmall'>
                <span
                  className='icon alt major solid fa-file'></span>
                <h3>Odio laoreet accumsan</h3>
                <p>Feugiat accumsan lorem eu ac lorem amet accumsan donec. Blandit orci porttitor.</p>
              </section>
              <section className='col4 col-6-medium col-12-xsmall'>
                <span
                  className='icon alt major solid fa-lock'></span>
          ...
          <footer className='major'>
            <ul className='actions special'>
              <li><a href='src/components/pages/landing/index.jsx#' className='button'>Magna sed feugiat</a></li>
            </ul>
          </footer>
        </div>
      </section>
